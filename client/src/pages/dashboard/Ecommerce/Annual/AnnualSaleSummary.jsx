...
const AnnualSaleSummary = ({data}): React$Element<any> => {
            ...
            datasets: [
                {
                    ...
                    barPercentage: 1,
                    data:data?.map((ele,ind)=>ele?.TotalExpenditure),
                ...
                },
                {
                    ...
                    categoryPercentage: 0.5,
                    barPercentage: 1,
                    data:data?.map((ele,ind)=>ele?.Revenue)
...
export default AnnualSaleSummary;
