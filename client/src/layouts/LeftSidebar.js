...
// images
import logoSm from '../assets/images/DR.ODinLogo.jpeg';
import logoDark from '../assets/images/DR.ODinLogo.jpeg';
import logoDarkSm from '../assets/images/DR.ODinLogo.jpeg';
            ...
            {!hideUserProfile && (
                <div className="leftbar-user">
                    <Link to="/">
                        ...
                        <span className="leftbar-user-name">Dr. Odin</span>
                    </Link>
                </div>
            )}
                    ...
                    <>
                        <Link to="/" className="logo text-center logo-light">
                            <span className="logo-lg">
                                <img src={isLight ? logoDark : logo} alt="logo" height="19" />
                            </span>
                            <span className="logo-sm">
                                <img src={isLight ? logoSm : logoDarkSm} alt="logo" height="12" />
                            </span>
                        </Link>
                        ...
                        <Link to="/" className="logo text-center logo-dark">
                            ...
                            <span className="logo-sm">
                                <img src={isLight ? logoSm : logoDarkSm} alt="logo" height="19" />
                            </span>
                        </Link>
                    </>
                )}
